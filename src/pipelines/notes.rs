...
impl NoteLocation {
    pub fn new(
        ...
        let x_pos = crate::utils::linear_map(
            note_kind as f32,
            0.,
            3.,
            -1.5,
        ...
        let note_pos = [x_pos, position];

        // create four "vertices", one for each of the corner of the note
        // rectangle
        [
            NoteLocation { note_pos: note_pos.clone(), corner_type: 0 },
            NoteLocation { note_pos: note_pos.clone(), corner_type: 1 },
            NoteLocation { note_pos: note_pos.clone(), corner_type: 2 },
            NoteLocation { note_pos: note_pos, corner_type: 3 },
        ]
    }
    ...
    pub fn from_vec4(
        ...
        let buffer = reordered_notes
            ...
            .flat_map(|(idx, (bt, tpos))| {
                ...
                NoteLocation::new(bt as u8, tpos).into_iter()
            })
            .collect::<Vec<_>>();
